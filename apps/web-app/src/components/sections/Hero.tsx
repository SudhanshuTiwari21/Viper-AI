...
const Icons = {
  notion: () => (
    <svg width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6.017 4.313l55.333-4.087c6.797-.583 8.543-.19 12.817 2.917l17.663 12.443c2.913 2.14 3.883 2.723 3.883 5.053v68.243c0 4.277-1.553 6.807-6.99 7.193L24.467 99.967c-4.08.193-6.023-.39-8.16-3.113L3.3 79.94C.967 76.827 0 74.497 0 71.773V11.113c0-3.497 1.553-6.413 6.017-6.8z" fill="#ffffff"/>
      <path d="M61.35.227L6.017 4.314C1.553 4.7 0 7.617 0 11.113v60.66c0 2.723.967 5.053 3.3 8.167l13.007 16.913c2.137 2.723 4.08 3.307 8.16 3.113l64.257-3.89c5.433-.387 6.99-2.917 6.99-7.193V20.64c0-2.21-.873-2.847-3.443-4.733L74.167 3.143C69.894.036 68.147-.357 61.35.227zM25.92 19.523c-5.247.353-6.437.433-9.417-1.99L8.927 11.507c-.77-.78-.383-1.753 1.557-1.947l53.193-3.887c4.467-.39 6.793 1.167 8.54 2.527l9.123 6.61c.39.197 1.36 1.36.193 1.36l-54.933 3.307-.68.047zM19.803 88.3V30.367c0-2.53.777-3.697 3.103-3.893L86 22.78c2.14-.193 3.107 1.167 3.107 3.693v57.547c0 2.53-.39 4.67-3.883 4.863l-60.377 3.5c-3.493.193-5.043-.97-5.043-4.083zm59.6-54.827c.387 1.75 0 3.5-1.75 3.7l-2.91.577v42.773c-2.527 1.36-4.853 2.137-6.797 2.137-3.107 0-3.883-.973-6.21-3.887L41.916 48.633v28.967l6.02 1.363s0 3.5-4.857 3.5l-13.39.777c-.39-.78 0-2.723 1.357-3.11l3.497-.97v-38.3L30.48 40.667c-.39-1.75.58-4.277 3.3-4.473l14.367-.967 19.8 30.327v-26.83l-5.047-.58c-.39-2.143 1.163-3.7 3.103-3.89l13.4-.78z" fill="#000000" fillRule="evenodd" clipRule="evenodd"/>
    </svg>
  ),
  github: () => (
    <svg width="32" height="32" viewBox="0 0 438.549 438.549" fill="white">
      <circle cx="219.275" cy="219.275" r="219.275" fill="black"/>
  ...
  cursor: () => (
    <svg width="32" height="32" viewBox="0 0 466.73 532.09" xmlns="http://www.w3.org/2000/svg">
      <path fill="white" d="M457.43,125.94L244.42,2.96c-6.84-3.95-15.28-3.95-22.12,0L9.3,125.94c-5.75,3.32-9.3,9.46-9.3,16.11v247.99c0,6.65,3.55,12.79,9.3,16.11l213.01,122.98c6.84,3.95,15.28,3.95,22.12,0l213.01-122.98c5.75-3.32,9.3-9.46,9.3-16.11v-247.99c0-6.65-3.55-12.79-9.3-16.11h-.01ZM444.05,151.99l-205.63,356.16c-1.39,2.4-5.06,1.42-5.06-1.36v-233.21c0-4.66-2.49-8.97-6.53-11.31L24.87,145.67c-2.4-1.39-1.42-5.06,1.36-5.06h411.26c5.84,0,9.49,6.33,6.57,11.39h-.01Z"/>
    </svg>
  ),
  vscode: () => (
    <svg width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen pt-16 pb-16 px-8 overflow-hidden flex items-center font-sans">
      ...
      {/* Radial glow */}
      <div
        className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] -z-10 pointer-events-none"
        style={{
          background:
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-[1.1] text-white mb-6">
            ...
            <span className="relative inline-flex h-[1.1em] w-full">
          ...
          {/* CTA */}
          <ShimmerButton type="button" className="h-12 px-7 text-sm font-semibold cursor-pointer hover:border-slate-500 hover:text-white hover:scale-[1.03] transition-transform duration-200">
            Get Started →
          </ShimmerButton>
        </div>
        ...
        <div className="hidden lg:flex items-center justify-center">
          <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden translate-x-12">
            ...
            {/* Inner orbit */}
            <OrbitingCircles className="size-[36px]" duration={20} delay={0} radius={100}>
              <Icons.notion />
            </OrbitingCircles>
            <OrbitingCircles className="size-[36px]" duration={20} delay={7} radius={100}>
              <Icons.github />
            </OrbitingCircles>
            <OrbitingCircles className="size-[36px]" duration={20} delay={14} radius={100}>
              <Icons.jira />
            </OrbitingCircles>

            {/* Outer orbit (reverse) */}
            <OrbitingCircles className="size-[44px]" duration={25} delay={0} radius={190} reverse>
              <Icons.openai />
            </OrbitingCircles>
            <OrbitingCircles className="size-[44px]" duration={25} delay={8} radius={190} reverse>
              <Icons.cursor />
            </OrbitingCircles>
            <OrbitingCircles className="size-[44px]" duration={25} delay={16} radius={190} reverse>
              <Icons.vscode />
            </OrbitingCircles>
          </div>
        </div>
